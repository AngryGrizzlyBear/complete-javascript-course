...
of 100. (Hint: you can read the value with the .value property in JavaScript. This is a good opportunity to use google
to figure this out :)
...
// This can be moved into an Anonymous function
// function btn() {
//     //Do something here
// }
// btn();
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    if (gamePlaying) {
        ...
        // reference scores[activePlayer] = scores[activePlayer] + roundScore;
